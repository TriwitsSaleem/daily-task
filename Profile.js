...
function Profile() {
 ...
 console.log('profile',state)
    console.log('data status',state)
      ...
      var config = {
       ...
       const [eventTableDetails, setEventTableDetails] = useState(null);
        const initializeEvent = () => {
         axios
           .get(`http://192.168.1.6/apis/api/Chat/getUser/${state.id}`)
           .then((response) => {
      ...
      axios.post("http://192.168.1.6/apis/api/Chat/user/", formdata, config)
      .then((res) => {
      console.log(res)
      if (res.status === 200) {
...
<div class="form_wrapper">
  ...
  <div class="input_field"><i aria-hidden="true" id='idd'></i>
      <h1>Update Profile</h1>
    </div>
<hr></hr>
<div id='dcc' onClick={()=>navigate("/EmployeeDocuments",{state:state})}>
        ...
        <div class="col_half">
                    ...
                    <div class="col_half">
                      ...
                      <div class="input_field"> <span id='sal'><i aria-hidden="true" class="fa fa-envelope" id='id'></i></span>
                      <input readOnly type="text" value={eventDetails.personalemail} name="personalemail" onChange={handleChangeInput} required />
                    </div>
                    </div>
                    </div>
        ...
        <div class="col_half">
                    ...
                    <div class="input_field"> <span id='sal'><i aria-hidden="true" class="fa fa-birthday-cake" id='id'></i></span>
                      ...
                      <input readOnly type="date" value={eventDetails.joiningdate} name="joiningdate" onChange={handleChangeInput} required />
                      </div>
                      </div>
                    </div>
